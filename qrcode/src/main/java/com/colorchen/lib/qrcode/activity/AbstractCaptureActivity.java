...
import com.colorchen.lib.qrcode.decoding.CaptureActivityHandler;
import com.colorchen.lib.qrcode.decoding.InactivityTimer;
import com.colorchen.lib.qrcode.view.ViewfinderView;
 ...
 */
public abstract class AbstractCaptureActivity extends Activity implements Callback, CaptureActivityHandler.DecodeCallback {
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            Toast.makeText(AbstractCaptureActivity.this, "扫描失败，请重试!", Toast.LENGTH_SHORT).show();
