...
import com.colorchen.lib.qmap.lbs.BDLocationService;
 ...
 */
public class KingLbs {

    final BDLocationService locationService;
    final LocationClientOption option;

    public KingLbs(Context context) {
        this(new Builder(context));
    }

    private KingLbs(Builder builder) {
    ...
    public static final class Builder {
        ...
        public KingLbs build() {
            return new KingLbs(this);
        }
        ...
        public Builder setOpenGps(boolean isOpen) {
            mOption.setOpenGps(isOpen);
            return this;
        }
    ...
    public static class LocationEntity {
        ...
        public boolean isInChina() {
            return this.bdLocation.getLocationWhere() == BDLocation.LOCATION_WHERE_IN_CN ? true : false;
        }
    ...
    public static abstract class LocationListener implements BDLocationListener {
        ...
        public final void onReceiveLocation(BDLocation bdLocation) {
            if (null != bdLocation && bdLocation.getLocType() != BDLocation.TypeServerError) {
                ...
                if (bdLocation.getLocType() == BDLocation.TypeServerError) {//167
                    errorMsg = "服务端定位失败，请您检查是否禁用获取位置信息权限，尝试重新请求定位";
                } else if (bdLocation.getLocType() == BDLocation.TypeNetWorkException) {//63
                    errorMsg = "网络异常，没有成功向服务器发起请求，请确认当前测试手机网络是否通畅，尝试重新请求定位";
                } else if (bdLocation.getLocType() == BDLocation.TypeCriteriaException) {//62
