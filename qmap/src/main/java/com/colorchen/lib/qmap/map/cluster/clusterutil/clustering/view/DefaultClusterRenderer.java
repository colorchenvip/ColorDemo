...
package com.colorchen.lib.qmap.map.cluster.clusterutil.clustering.view;
...
import com.colorchen.lib.qmap.map.cluster.MarkerManager;
import com.colorchen.lib.qmap.map.cluster.clusterutil.clustering.Cluster;
...
import com.colorchen.lib.qmap.map.cluster.clusterutil.projection.Point;
import com.colorchen.lib.qmap.map.cluster.clusterutil.projection.SphericalMercatorProjection;
import com.colorchen.lib.qmap.map.cluster.clusterutil.ui.IconGenerator;
import com.colorchen.lib.qmap.map.cluster.clusterutil.ui.SquareTextView;
...
import static com.colorchen.lib.qmap.map.cluster.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
